:; printf '{}\n'; exit 0
@echo off
rem Windows entry point for the TrustGuard Claude Code plugin hooks. The first line
...
rem rather than handing Claude Code an empty stdout. cmd.exe reads it as a label
